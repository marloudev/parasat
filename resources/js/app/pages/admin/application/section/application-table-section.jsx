...
import AssignJobOrderSection from "./assign-job-order-section";
                        ...
                        applications.map((application, index) => (
                            <tr key={application.email}>
                                <td className="w-full max-w-0 py-4 pl-4 pr-3 text-sm text-gray-900 sm:w-auto sm:max-w-none sm:pl-0">
                                    ...
                                    {application.lname} {application.suffix}
                                </td>
                                ...
                                <td className="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">
                                    {application.lot} {application.barangay},{" "}
                                    {application.city}, {application.province}
                                </td>
                                <td className="py-4 text-sm font-medium sm:pr-0 ">
                                    <p
                                        className={`py-2 items-center justify-center flex rounded-md w-24 text- text-sm font-medium sm:pr-0 
                                    ${
                                ...
                                <td className="flex gap-2 py-5 px-2 text-sm font-medium sm:pr-0 ">
                                    {(application?.status == "Survey" ||
                                        application?.status == "Installation" ||
                                        application?.status == "Pending" ||
