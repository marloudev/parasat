...
import Card from '@/app/pages/_components/card';
import Avatar from '@/app/pages/_components/avatar';
import InputField from '@/app/pages/_components/inputfield';
import Progress from '@/app/pages/_components/progress';
import Select from '@/app/pages/_components/select';
import Table from '@/app/pages/_components/table';
import Pagination from '@/app/pages/_components/pagination';
import Modal from '@/app/pages/_components/modal';
import Drawer from '@/app/pages/_components/drawer';
import Tab from '@/app/pages/_components/tab';
import Collapse from '@/app/pages/_components/collapse';
import Alert from '@/app/pages/_components/alert';
import AdminLayout from '../../layout';

export default function AdminDashboardPageComponents() {
