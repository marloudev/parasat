...
export default function UploadValidIDSection({ files, setFiles }) {
    ...
    return (
        <div>
            <h1 className="text-xl font-semibold mb-3 text-gray-900 mt-9">Upload Valid ID (<i>front & back</i>)</h1>
