...
export default function TopBarSection() {
    ...
    return (
        <div>
            <div className="bg-gray-800 top-bar fixed top-0 left-0 w-screen z-50 shadow-md">
                <div className="mx-auto sm:px-10">
                   <div className="relative flex h-16 items-center justify-between w-full px-4 md:px-8">
  <div className="w-full">
    <img src="/images/para-fiber.jpg" className="h-10 md:h-12" alt="Logo" />
  </div>
  <div className="flex gap-5 w-full text-white items-center justify-end text-sm md:text-base">
  ...
  <div className="fixed bottom-10 right-14 flex items-center justify-center md:right-8 lg:right-14">
    {/* Settings button */}
    <button
